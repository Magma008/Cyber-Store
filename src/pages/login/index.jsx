    ...
    <div className='min-h-[60vh] flex justify-center items-center'>
      <div className='min-h-[60vh] flex justify-center items-center'>
        <div className="bg-amber-400 p-4 sm:p-6 rounded-xl flex-col gap-5 flex">
          <h1 className="text-center text-3xl mb-5 font-semibold text-white">Log In</h1>
          <form className='flex flex-col gap-5'>
            <input required type="text" placeholder='Username' className='min-w-[300px] outline-0 border-2 rounded-md border-white px-4 py-1.5 placeholder:text-cyan-700 text-white' />
            {/* <input type="email" placeholder='Email' className='min-w-[300px] outline-0 border-2 rounded-md border-white px-4 py-1.5 placeholder:text-cyan-700 text-white' /> */}
            <div className="relative">
              <input required type={`${visible ? "text" : "password"}`} placeholder='Password' className='min-w-[300px] outline-0 border-2 rounded-md border-white px-4 py-1.5 placeholder:text-cyan-700 text-white' />
          ...
          <p className='text-[13px] text-center text-white'>Don't have an account? <Link to="/signup"><span className='text-red-600 underline'>Create one</span></Link></p>
        </div>
      </div>
    </div>
  )
